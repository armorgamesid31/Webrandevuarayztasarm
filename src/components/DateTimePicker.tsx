        ...
        <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
          {dates.map((date) => (
            <button
              ...
              className={`flex-shrink-0 w-16 px-3 py-3 rounded-[15px] text-center transition-all ${
                  ...
                  return (
                    <div key={time} className="relative">
                      <button
                        ...
                        className={`w-full py-3 px-2 rounded-[12px] text-sm font-medium transition-all ${
                          isSelected
                            ? 'bg-[#D4AF37] text-white shadow-md'
                            : 'bg-gray-50 hover:bg-gray-100 text-[#2D2D2D]'
                        }`}
